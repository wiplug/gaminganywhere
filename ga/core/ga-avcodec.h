...
EXPORT AVCodec* ga_avcodec_find_encoder(char **names, enum CodecID cid = AV_CODEC_ID_NONE);
EXPORT AVCodec* ga_avcodec_find_decoder(char **names, enum CodecID cid = AV_CODEC_ID_NONE);
